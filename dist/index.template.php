...
function template_init()
{
	...
	$settings['color_palettes'] = array(
		'default' => array(
			'background' => '#000000',
			'foreground' => '#e8e8e8',
			'primary_color' => '#152028',
			'secondary_color' => '#650505',
			'links' => '#d6ddeb',
			'gradient_end' => '#171820',
			'gradient_start' => '#0f1724',
			'blocks_color' => '#0a0a18',
			'blocks_alternate_color' => '#120b15',
			'content_target_bg' => '#432139',
			'borders_color' => '#3e0000',
			'top_section' => '#4e4e4e',
			'footer' => '#191919',
			'buttons_text_color' => '#282828',
			'buttons_bg' => '#858585',
			'buttons_border' => '#919191',
			'special_titles_color' => '#f5d078',
			'sticky_topic' => '#1f2730',
			'sticky_locked_topic' => '#2b1f1e',
			'unapproved_topic' => '#221815',
			'locked_topic' => '#26292f',
			'remove_shadows' => true
		)
	);
